    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M20.37 3H17.6l-4.17 5.14L8.83 3H3.5l6.78 9.12L3.27 21h2.77l4.53-5.6 4.86 5.6h5.43l-7.09-9.13L20.37 3zm-3.39 15h-1.47l-6.09-7.01h1.45l6.11 7.01z" />
        </svg>
      ),
    },
  ];
